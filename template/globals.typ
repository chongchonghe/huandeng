...
// University pads section slides by 20% a side, leaving 60% of the width for the title — a real
// section name wraps. And its focus-slide sets 2em, which suits three words, not a sentence.
#let uni-section-slide(config: (:), level: 1, numbered: true, body) = touying-slide-wrapper(self => {
  let slide-body = {
