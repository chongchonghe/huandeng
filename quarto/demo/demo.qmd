...
- `out/demo.pdf` — one page per slide
...
:::
::: {.media-items}
![](attach/placeholder-image.png){width="150px"} ![](attach/placeholder-image.png){width="150px"} ![](attach/placeholder-image.png){width="150px"}
:::
::::
...
:::
::: {.media-items}
![](attach/slide-fld/shadow-labeled.png){width="230px"} ![](attach/slide-m1-quokka/shadow-quokka.png){width="230px"}
:::
::::

::: {.caption-line}
Give each image a width or a height, never both: two dimensions crop the figure
instead of fitting it, and `make check` fails the deck if the drawn shape and
the file's own shape disagree by more than 2%.
:::
...
:::
::: {.media-items}
![](attach/slide-fld/shadow-labeled.png){height="98px"} ![](attach/slide-fld/shadow-labeled.png){height="98px"} ![](attach/slide-fld/shadow-labeled.png){height="98px"}
:::
::::
...
::: {.caption-line}
Time evolution under three radiation transport methods. A grid here is three
`.media-row`s, not a table, so every panel keeps its own aspect ratio. Each row
sizes its own label column, so the wrapper sets `--label-width` once to line
them up.
:::
...
::: {.r-stack}
![](attach/zoom-steps/step-1.png){height="330px"}

::: {.fragment .fade-in-then-out}
![](attach/zoom-steps/step-2.png){height="330px"}
:::

::: {.fragment .fade-in-then-out}
![](attach/zoom-steps/step-3.png){height="330px"}
:::

::: {.fragment .fade-in-then-out}
![](attach/zoom-steps/step-4.png){height="330px"}
:::
:::
...
- `.columns-1-1`, `.columns-2-1`, `.columns-3-2`, `.columns-1-1-1`
...
- **B** blank the screen · **M** menu · `?` all keys
