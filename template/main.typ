...
#show: university-theme.with(
  ...
  config-common(slide-fn: uni-slide, new-section-slide-fn: uni-section-slide),
  // Short forms used by the footer.
  config-store(short-institution: [Your Institute]),
  config-info(
    title: [Your Talk Title],
    subtitle: [Subtitle, or delete this line],
    author: [Your Name],
    short-title: [Short Title],
    date: datetime.today(),
    institution: [Your Institute],
    // Drop a logo in attach/ and point at it, or delete this line.
    // logo: image("attach/logo.png", width: 2.5cm),
  ),
  config-common(
